...
if (isset($_GET['url'])) {
    ...
    /**
     * Existiert der Array Schlüssel für die aufgerufene URL noch nicht, so setzen wir ihn hier und den zugehörigen
     * Wert auf 1. Existiert der Schlüssel schon, erhöhen wir den Wert um 1.
     */
