        ...
        <div class="col">
            ...
            <div class="form-group">
                ...
                <select name="files[]" id="files" class="form-control" multiple>
                    ...
                    /**
                     * Damit wir eine Liste an Files dynamisch generieren können, müssen wir mit einer Schleife
                     * arbeiten.
                     *
                     * Hier ist der Ternäre Operator zu beachten, den wir verwenden um anzugeben, ob eine Eintrag
                     * ausgewählt sein soll oder nicht.
                     */
                    foreach ($files as $file) : ?>
                        <option value="<?php echo $file->id; ?>"<?php echo(in_array($file, $postFiles) ? ' selected' : ''); ?>><?php echo "{$file->title} [{$file->name}]"; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
