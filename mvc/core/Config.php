...
class Config
{
     ...
     *
     * @param string $filenameAndIndex Format: filename.arrayKey
     * @param mixed  $default          Wert der zurückgegeben wird, wenn das File oder der Index nicht gefunden wurden
     *
     * @return mixed
     */
    public static function get (string $filenameAndIndex, mixed $default = null): mixed
    {
        /**
         ...
         */
        [$filename, $index] = explode('.', $filenameAndIndex);
        ...
        if (file_exists($path)) {
             ...
             * zweimal hinter einander im selben Skript-Durchlauf Werte aus der selben Config Datei ausgelesen werden
